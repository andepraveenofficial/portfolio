...
![DBMS Flow](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711430974/portfolio/markdown/sqlite/dbms-flow.png)
...
![Relational Database](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711431091/portfolio/markdown/sqlite/relational-database.png)
...
![Non-Relational Database](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711431091/portfolio/markdown/sqlite/non-relational-database.png)
</details>
...
* SQL provides multiple commands to perform (CRUD) various operations like `create`, `retrive`, `update` and `delete` the data.

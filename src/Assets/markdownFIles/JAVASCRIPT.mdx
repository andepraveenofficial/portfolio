...
![Code](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006635/portfolio/markdown/javascript/scope/closure.png)
...
#### Code
![Code](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006774/portfolio/markdown/javascript/js_environment/Javascript_Code.jpg)

#### JS Runtime Environment
![JS Runtime Environment](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006778/portfolio/markdown/javascript/js_environment/Javascript_Runtime_Environment.jpg)

#### JS Engine
![JS Engine](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006766/portfolio/markdown/javascript/js_environment/Callstack.jpg)

#### Web APIs
![Code](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006781/portfolio/markdown/javascript/js_environment/Web_APIs.jpg)


##### Execution Context
![Execution Context](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711006772/portfolio/markdown/javascript/js_environment/Execution__Context.jpg)
...
##### Hoisting
![Hoisting](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007204/portfolio/markdown/javascript/code_working/hoisting/01_Hoisting.webp)  
![Function Storage](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007206/portfolio/markdown/javascript/code_working/hoisting/02_Function_Storage.gif)  
![Variable Storage](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007210/portfolio/markdown/javascript/code_working/hoisting/03_Variable_Storage.gif)  
![var Keyword Storage](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007214/portfolio/markdown/javascript/code_working/hoisting/04_var_keyword_Storage.gif)  
![Execution Phase](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007217/portfolio/markdown/javascript/code_working/hoisting/05_Execution_Phase.gif)  
![undefined](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007221/portfolio/markdown/javascript/code_working/hoisting/06_undefined.gif)  
![Reference Error](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007225/portfolio/markdown/javascript/code_working/hoisting/07_Reference_Error.gif)  
![Assign Original Values](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711007239/portfolio/markdown/javascript/code_working/hoisting/08_Assign_Original_Values.gif)  

##### Event Loop
![JS Runtime Environment Event Loop](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015404/portfolio/markdown/javascript/code_working/event_loop/01_JS_Runtime_Environment.webp)  
![Callstack](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015405/portfolio/markdown/javascript/code_working/event_loop/02_Callstack.gif)  
![Timer](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015407/portfolio/markdown/javascript/code_working/event_loop/03_Timer.gif)  
![Callback Queue](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015406/portfolio/markdown/javascript/code_working/event_loop/04_Callback_Queue.gif)  
![Event Loop](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015407/portfolio/markdown/javascript/code_working/event_loop/05_Event_Loop.gif)  
![output](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015409/portfolio/markdown/javascript/code_working/event_loop/06_Output.gif)  
![Timer Example](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015411/portfolio/markdown/javascript/code_working/event_loop/07_Timer_Example.gif)  

##### Microtask Queue
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask1.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask2.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask3.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask4.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask5.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask6.gif)  
![Microtask](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711015967/portfolio/markdown/javascript/code_working/microtask_queue/microtask7.gif)  
...
![debouncing.gif](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016632/portfolio/markdown/javascript/core_javascript/debouncing.gif)
...
```
![throttle.gif](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016644/portfolio/markdown/javascript/core_javascript/throttle.gif)
![throttling-vs-debounce.png](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016645/portfolio/markdown/javascript/core_javascript/throttling-vs-debounce.png)
...
* Capturing
![01 Capturing.png](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016601/portfolio/markdown/javascript/core_javascript/Capturing.png)
* bubbling (Default)
![02 bubbling.png](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711017014/portfolio/markdown/javascript/core_javascript/bubbling.png)
...
### async vs await 
![async vs defer.avif](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016626/portfolio/markdown/javascript/core_javascript/async_vs_defer.avif)
...
let magicFunction = function(obj, parent) {
 ...
 magicFunction(user, "user")
  console.log(output)
```
![recursively.png](https://res.cloudinary.com/dwrwbjd3h/image/upload/v1711016636/portfolio/markdown/javascript/core_javascript/recursively.png)

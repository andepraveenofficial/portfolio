...
we can create Dynamic Webpages by combining HTML with Javascript.
...
if there is any Microtask functions or callback functions , it automatically pushes it into the callstack then delete from queue.  
